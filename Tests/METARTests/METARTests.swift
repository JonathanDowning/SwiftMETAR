...
final class METARTests: XCTestCase {
    ...
    func testWind() throws {
        try XCTAssertEqual(XCTUnwrap(METAR(rawMETAR: "EGGD 121212Z 33008G15KT 300V360")).wind, .init(direction: .init(value: 330, unit: .degrees), speed: .init(value: 8, unit: .knots), gustSpeed: .init(value: 15, unit: .knots), variation: .init(from: .init(value: 300, unit: .degrees), to: .init(value: 360, unit: .degrees))))
    }
